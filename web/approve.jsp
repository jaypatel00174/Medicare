                ...
                <TR>
                    ...
                    <TD COLSPAN=29>
                        ...
                        <table cellpadding="5" cellspacing="1" align=center >
                            <%                                out.println("<th>username</th><th>licence no</th><th>click for add </th><th>Click for remove</th>");
                            %>
                            <%
                                rs = s.executeQuery("select * from app.doctor where id=0");
                                while (rs.next()) {
                            ...
                            <tr> 
                                ...
                                <td height="20" width="200"bgColor= #BFBFBF ><font face="Verdana" size="2"><%=rs.getString(7)%></font></td>
                                <td height="20" width="200"bgColor= #BFBFBF ><font face="Verdana" size="2"><%out.println("<a href='adddoc.jsp?j=" + st + "'>ADD</a>");%></font></td>
                                <td height="20" width="70"bgColor=#6AA3D0 ><font face="Verdana" size="2"><%out.println("<a href='rdoc.jsp?i=" + st + "'>REMOVE</a>");%></font></td>
                                    <%
                                        }
                                    %>
