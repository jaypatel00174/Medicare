        ...
        <div id="main-wrapper">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center templatemo-logo margin-top-20">
                ...
                <h3 class="templatemo-site-title">
                    hello <span class="blue"><%=u_id%></span>
                </h3>
                 <font size="2">  Back to <a href="userhome.jsp"> home</a>.</font>
            </div>
            ...
            <table align="center">
                <TR>
                    <TD>&nbsp;</TD>
                    <TD COLSPAN=29>
                        <b><font face="Verdana" size="2" color="#666666">Doctor's reply:</font></b><p>&nbsp;</p>
                        <table cellpadding="5" cellspacing="1" align=center >
                            <%                                out.println("<th>id</th><th>name</th><th>email</th><th>problem</th><th>doctor</th><th>reply</th>");
                            %>
                            <%
                                rs = s.executeQuery("select * from APP.TBLPROBLEM where name='"+u_id+"' ORDER BY id DESC");
                                while (rs.next()) {
                            ...
                            <tr> 
                                ...
                                <td height="20" width="200"bgColor= #BFBFBF style="outline: thin solid"><font face="Verdana" size="2"><%=rs.getString(6)%></font></td>
