        ...
        <div id="main-wrapper">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center templatemo-logo margin-top-20">
                ...
                <h3 class="templatemo-site-title">
                 ...
                 <font size="2">  Back to <a href="dochome.jsp"> home</a>.</font>
            </div>
                ...
                <TR>
                    ...
                    <TD COLSPAN=29>
                        ...
                        <table cellpadding="5" cellspacing="1" align=center >
                            <%                                out.println("<th>id</th><th>name</th><th>email</th><th>problem</th><th>Click for reply</th>");
                            %>
                            <%
                                rs = s.executeQuery("select * from APP.TBLPROBLEM where doctor='"+u_id+"' AND solution is null");
                                while (rs.next()) {
                            ...
                            <tr> 
                                ...
                                <td height="20" width="200"bgColor= #BFBFBF ><font face="Verdana" size="2"><%=rs.getString(4)%></font></td>
                                <td height="20" width="70"bgColor=#6AA3D0 ><font face="Verdana" size="2"><%out.println("<a href='reply.jsp?i=" + st + "'>Reply</a>");%></font></td>
                                    <%
                                        }
                                    %>
